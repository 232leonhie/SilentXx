...
document.getElementById('joinDiscordBtn').addEventListener('click', () => {
    window.open('https://discord.gg/6Dj8nQSmzp', '_blank');
    
    // Change modal content after Discord link is clicked
    document.getElementById('modalText').textContent = 'To further access Comet feature more freely, you will need to generate a key.';
...
document.querySelectorAll('.cta-group .btn-primary, .pricing-card:not(.popular) .btn-primary').forEach(downloadBtn => {
    downloadBtn.addEventListener('click', () => {
        ...
        window.open('https://gofile.io/d/JFx8nN', '_blank', 'noopener,noreferrer');
    });
});
